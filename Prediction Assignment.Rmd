...
```
For fast and accurate training the model, I've ensured to choose XGBoost, an implementation of tree-based extreme gradient boosting algorithm. (*As discussed in the course's forum, this tool is confirmed by course's CTA to be allowed to be used in this assignment project.*)   
